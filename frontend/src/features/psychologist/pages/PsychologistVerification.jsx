        ...
        <div className="verify-card">
          ...
          {status === "check-email" && (
            <>
              ...
              <p className="verify-instruction">
                ...
                psychologist account and start your professional journey.
              </p>
              <Link to="/psychologist/login" style={{ textDecoration: 'none' }}>
          ...
          {status === "error" && (
            <>
              ...
              <Link to="/psychologist/signup" style={{ textDecoration: 'none' }}>
                <button className="resend-btn">
                  Back to Signup
                </button>
              </Link>
