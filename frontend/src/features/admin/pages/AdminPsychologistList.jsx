...
const SORT_OPTIONS = [
    ...
    { label: "Experience (High → Low)", sortBy: "experience", sortDir: "desc" },
...
const FILTER_OPTIONS = [
    { label: "All Psychologists", value: "all" },
...
export default function AdminPsychologistList() {
    ...
    const handleSearchChange = useCallback((e) => {
        ...
        setInputVal(val);
        clearTimeout(window._aplPsySearchTimer);
    ...
    const { data, isLoading, isError } = useQuery({
        ...
        queryFn: () => fetchAdminPsychologists({ page, pageSize, search, sortBy, sortDir, filterStatus }),
        keepPreviousData: true,
    });

    const suspendMutation = useMutation({
        mutationFn: (psychologistId) => togglePsychologistSuspension(psychologistId),
        onSuccess: () => { queryClient.invalidateQueries(["admin-psychologists"]); setSuspendTarget(null); },
    });

    const psychologists = data?.results || [];
        ...
        <div className="flex min-h-screen bg-admin-gradient font-['DM_Sans',sans-serif]">
            ...
            <div className="flex-1 ml-[220px] flex flex-col">
                ...
                <div className="flex-1 mt-[60px] p-6 lg:p-8">
                    <div className="mb-7">
                        <h1 className="font-outfit text-2xl font-bold text-slate-100 tracking-tight">Psychologists</h1>
                        <p className="text-slate-400 text-sm mt-1">Manage approved psychologists and their account status.</p>
                    </div>
                                        ...
                                        <td className={tdCls}>
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="text-[11px] text-slate-500">ID: {p.psychologist_id}</div>
                                                </div>
                                            </div>
                                        </td>
            ...
            {suspendTarget && (
                <SuspendConfirmModal
                    ...
                    onConfirm={() => suspendMutation.mutate(suspendTarget.psychologist_id)}
