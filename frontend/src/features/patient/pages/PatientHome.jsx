...
const publicStats = [
  ...
  { value: "500+", label: "Expert Psychologists" },
  { value: "98%", label: "Satisfaction Rate" },
  { value: "24/7", label: "Always Available" },
];

const publicFeatures = [
  { icon: (<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" /></svg>), title: "Personalised Consultation", description: "Get matched with a licensed psychologist who fits your needs, schedule, and communication style." },
  ...
  { icon: (<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><circle cx="12" cy="12" r="10" /><line x1="2" y1="12" x2="22" y2="12" /><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" /></svg>), title: "Video & Chat Sessions", description: "Attend consultation from anywhere — via video call or secure messaging, whichever you prefer." },
...
const dashboardTiles = [
  ...
  { icon: (<svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><rect x="5" y="8" width="14" height="10" rx="3" /><path d="M12 4v4" /><path d="M8 13h.01" /><path d="M16 13h.01" /><path d="M9 18v2" /><path d="M15 18v2" /></svg>), title: "AI Chatbot Assistant", desc: "Ask about booking, consultations, departments, and basic wellness guidance.", action: "Start Chat", featured: true, purple: true, opensChatbot: true },
  { icon: (<svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></svg>), title: "Browse Psychologists", desc: "Browse verified, licensed psychologists and find the right fit for you.", action: "Explore →", to: "/patient/psychologists" },
  { icon: (<svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><rect x="3" y="4" width="18" height="18" rx="2" /><line x1="16" y1="2" x2="16" y2="6" /><line x1="8" y1="2" x2="8" y2="6" /><line x1="3" y1="10" x2="21" y2="10" /></svg>), title: "Book a Session", desc: "Schedule a consultation session at a time that works for you.", action: "Book Now →", to: "/patient/psychologists" },
  { icon: (<svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></svg>), title: "Secure Chat", desc: "Message your psychologist anytime between sessions, safely and privately.", action: "Open Chat →", to: "/patient/messages" },
];
...
export default function PatientHome() {
  ...
  const openChatbot = () => window.dispatchEvent(new Event("open-patient-chatbot"));
            ...
            {dashboardTiles.map((tile) => (
              tile.opensChatbot ? (
                <button
                  ...
                  type="button"
                  onClick={openChatbot}
                  className={`relative bg-white border border-ui-200 rounded-[16px] p-7 flex items-start gap-[1.1rem] cursor-pointer text-left no-underline transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(26,190,170,0.1)] hover:border-[rgba(26,190,170,0.3)] ${tile.featured ? "md:col-span-2 shadow-[0_8px_26px_rgba(15,23,42,0.05)]" : ""}`}
                >
                  {tile.featured && (
                    <span className={`absolute right-6 top-6 rounded-[10px] px-4 py-2 text-xs font-extrabold text-white ${tile.purple ? "bg-[#5b5ff0]" : "bg-[#9a3ff2]"}`}>
                      {tile.purple ? "Assistant" : "New AI"}
                    </span>
                  )}
                  <div className={`w-[52px] h-[52px] flex-shrink-0 rounded-[13px] flex items-center justify-center transition-all duration-200 ${tile.featured ? tile.purple ? "bg-[#e5e7ff] text-[#5b5ff0]" : "bg-[#ecdcff] text-[#9a3ff2]" : "bg-gradient-to-br from-[rgba(26,190,170,0.08)] to-[rgba(20,160,144,0.1)] text-patient-primary"}`}>
                    {tile.icon}
                  </div>
      ...
      <section className="relative overflow-hidden pt-36 pb-16 px-8 text-center bg-gradient-to-[160deg] from-[#f0fdf9] via-[#f8fafc] to-[#edfcf7]"
        ...
        <div className="relative z-10 max-w-[680px] mx-auto animate-[phFadeUp_0.7s_ease-out_both]">
          ...
          <p className="text-[1.05rem] text-[#4b5563] leading-[1.75] max-w-[560px] mx-auto mb-9">
            Koode connects you with licensed psychologists for personalised, confidential support — whenever and wherever you need it.
          </p>
