...
from accounts.tasks import send_admin_reset_email
...
class AdminPasswordResetService:
    ...
    def request_reset(self, email):
        ...
        reset_link = f"{settings.ADMIN_FRONTEND_URL}/admin/reset-password?token={token}"
        send_admin_reset_email.delay(user.email, reset_link)
