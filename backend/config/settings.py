...
ZEGO_CLOUD_RECORDING_API_URL = os.getenv("ZEGO_CLOUD_RECORDING_API_URL")
ZEGO_RECORDING_OUTPUT_FOLDER = os.getenv("ZEGO_RECORDING_OUTPUT_FOLDER")
ZEGO_RECORDING_S3_VENDOR = int(os.getenv("ZEGO_RECORDING_S3_VENDOR"))
